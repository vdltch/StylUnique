...
function chic_lite_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info = '<p>';
	$theme_info .= sprintf( __( 'Demo Link: %1$sClick here.%2$s', 'chic-lite' ),  '<a href="' . esc_url( 'https://rarathemes.com/previews/?theme=chic-lite&utm_source=chic_lite&utm_medium=customizer&utm_campaign=theme_demo' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( 'Documentation Link: %1$sClick here.%2$s', 'chic-lite' ),  '<a href="' . esc_url( 'https://docs.rarathemes.com/docs/chic-lite/?utm_source=chic_lite&utm_medium=customizer&utm_campaign=docs' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p>';
	...
	$manager->add_section(
		new Chic_Lite_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => esc_url( 'https://rarathemes.com/wordpress-themes/chic-pro/?utm_source=chic_lite&utm_medium=customizer&utm_campaign=upgrade_to_pro' ) 
			)
		)
	);
}
