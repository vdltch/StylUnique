...
function chic_lite_setup() {
    ...
    */    
    ...
    add_image_size( 'chic-lite-latest', 720, 420, true );
...
function chic_lite_admin_notice(){
    ...
    $dismissnonce    = wp_create_nonce( 'chic_lite_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=chic-lite-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the dashboard.', 'chic-lite' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?chic_lite_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'chic-lite' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function chic_lite_update_admin_notice(){
    ...
    if (!current_user_can('manage_options')) {
     ...
     if ( ( isset( $_GET['chic_lite_admin_notice'] ) && $_GET['chic_lite_admin_notice'] = '1' ) && wp_verify_nonce( $_GET['_wpnonce'], 'chic_lite_admin_notice' ) ) {
