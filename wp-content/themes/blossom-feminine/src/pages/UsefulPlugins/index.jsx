...
const pluginList = [
    {
        pluginName: __('BlossomThemes Toolkit', 'blossom-feminine'),
        description: __("BlossomThemes Toolkit provides you necessary widgets for better and effective blogging.", "blossom-feminine"),
        slug: "blossomthemes-toolkit"
    },
    {
        pluginName:__('BlossomThemes Email Newsletter', 'blossom-feminine'),
        description: __("Easily add email subscription form to your website using shortcode and widget.", "blossom-feminine"),
        slug: "blossomthemes-email-newsletter"
    },
    {
        pluginName: __('Regenerate Thumbnails', 'blossom-feminine') ,
        description: __("Regenerate the thumbnails for one or more of your image uploads. Useful when changing their sizes or your theme.", "blossom-feminine"),
        slug: "regenerate-thumbnails"
    },
    {
        pluginName: __('AffiliateX – Best Amazon Affiliate WordPress Plugin', 'blossom-feminine'),
        description: __("Create a professional-looking affiliate websites with highly customizable blocks that help in increasing the conversion rate and boost your affiliate income.", "blossom-feminine"),
        slug: "affiliatex"
    },
    {
        pluginName: __('Smash Balloon Social Photo Feed', 'blossom-feminine'),
        description: __("Formerly 'Instagram Feed'. Display clean, customizable, and responsive Instagram feeds from multiple accounts. Supports Instagram oEmbeds.", "blossom-feminine"),
        slug: "instagram-feed"
    },
];
