	...
	$manager->add_section(
		new Blossom_Fashion_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => esc_url( 'https://blossomthemes.com/wordpress-themes/blossom-fashion-pro/?utm_source=free_theme&utm_medium=customizer&utm_campaign=pro_theme_upgrade' ),
			)
		)
	);
}